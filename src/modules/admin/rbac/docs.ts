...
export const adminDocs = {
  listStaffUsers: {
    detail: adminDetail({
      ...
      required: ['Authorization: Bearer <access_token>', "permission 'manage_users' atau 'manage_staff'"],
      optional: [],
  ...
  getRoles: {
    detail: adminDetail({
      ...
      required: ['Authorization: Bearer <access_token>', "permission 'manage_users', 'manage_roles', atau 'manage_staff'"],
      optional: [],
  ...
  createRole: {
    ...
    detail: adminDetail({
      ...
      required: ['name', 'Authorization: Bearer <access_token>', "permission 'manage_roles' atau 'manage_staff'"],
      optional: [],
      successStatus: 201,
  ...
  getStaffRoles: {
    ...
    detail: adminDetail({
      ...
      required: ['path id', 'Authorization: Bearer <access_token>', "permission 'manage_users' atau 'manage_staff'"],
      optional: [],
  ...
  assignRole: {
    ...
    detail: adminDetail({
      ...
      required: ['path id', 'role_id', 'Authorization: Bearer <access_token>', "permission 'manage_users' atau 'manage_staff'"],
      optional: ['branch_id'],
      successStatus: 201,
  ...
  revokeRole: {
    ...
    detail: adminDetail({
      ...
      required: ['path id', 'path roleId', 'Authorization: Bearer <access_token>', "permission 'manage_users' atau 'manage_staff'"],
      optional: [],
