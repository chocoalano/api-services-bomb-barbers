...
export const barberAppointmentRoutes = new Elysia({ prefix: '/api/v1' })
  ...
  .group('/barbers', (app) => app
    ...
    .patch('/appointments/:id/payment/verify', BarberAppointmentController.verifyPaymentOnly)
    ...
    .patch('/appointments/:id/depart', BarberAppointmentController.departToLocation)
  ...
  .group('/barber', (app) => app
    ...
    .patch('/appointments/:id/depart', deprecated('/api/v1/barbers/appointments/:id/depart', BarberAppointmentController.departToLocation), deprecatedDetail)
